  ...
  return (
    <div className="category-page">
        ...
        <div className="container">
          <div className="cat-hero-grid">
            <div className="cat-hero-info">
              <Reveal>
                <span className="label cat-hero-label">УСЛУГИ / {category.id}</span>
              </Reveal>
              <Reveal delay={100}>
        ...
        <div className="container">
          <Reveal>
            <div className="cat-desc">
              <span className="label">О услуге</span>
          ...
          <div className="cat-products">
            {category.serviceTypes.map((st, i) => (
              <Reveal key={st.id} delay={i * 80}>
                <button className="cat-product" onClick={() => setSelectedService(st)}>
                  <div className="cat-product-image">
                    <Placeholder label={st.name.toUpperCase()} aspect="4/3" />
                  </div>
                  <div className="cat-product-info">
                    <h3 className="h4 cat-product-title">{st.name}</h3>
                    <p className="body-sm cat-product-desc">{st.description}</p>
      ...
      <section className="section">
        <div className="container">
          <Reveal>
            <SectionHeader label="ПРОЦЕСС" title="От заявки до сдачи объекта" />
          </Reveal>
        ...
        <div className="container">
          <div className="cat-lead">
            <div className="cat-lead-left">
              ...
              <Reveal delay={100}>
                <p className="body-lg cat-lead-text">Опишите задачу — рассчитаем стоимость и сроки.</p>
              </Reveal>
            </div>
      ...
      <ProductModal
        product={selectedService ? {
          ...
          characteristics: selectedService.characteristics,
          dimensions: '',
          weight: '',
          material: '',
          coating: '',
